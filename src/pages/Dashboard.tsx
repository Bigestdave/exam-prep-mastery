...
import { MobileBottomNav } from "@/components/MobileBottomNav"; // Ensure this is imported!
...
export default function Dashboard() {
  ...
  return (
    // Added pb-24 to ensure content doesn't get hidden behind the nav bar
    <div className="min-h-screen bg-[#F8FAFC] pb-24 md:pb-0 animate-fade-in">
      <Header isLoggedIn userName={profile?.full_name || ''} />
      
      <main className="container py-8 px-4 md:px-6">
        <div className="mb-8">
          {/* FIX: Forced Hex Code for Deep Navy color */}
      ...
      {/* CRITICAL: This renders the nav bar */}
      <MobileBottomNav />
    </div>
  );
}
